...
#Indent, Debug, Refactor(add comments)
class Drawer
...
Even though the Drawer Debugger challenge was a new concept it helped to
review creating classes in Ruby with instance variables, local variables,
and instance methods as well as reading errors.

What is still confusing to you about Ruby?
Remembering not to confuse Ruby syntax & semantics with JavaScript
syntax & semantics.

What are you going to study to get more prepared for Phase 1?
I will continue to work on other challenges in the Ruby Review module.
